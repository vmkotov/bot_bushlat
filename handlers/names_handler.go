...
// nameMapping карта соответствий: вариант написания -> готовый ответ
var nameMapping = map[string]string{
	// Славик и его варианты
	"славик":      "Славик абсолютно конченная поебота",
	"сплавик":     "Не Сплавик, а Вячеслав!", // Добавили вариант "славон"
	...
	"бушлат":      "Дайте Бушлату кто-то в ебло, он уже всех тут заебалт",
	...
	// 👇 ДОБАВЛЯЙТЕ НОВЫЕ ИМЕНА И ВАРИАНТЫ ЗДЕСЬ
	// Формат:
	// "вариант_написания": "ГотовыйОтвет",
}
...
func CheckForNames(text, userName string) (bool, string) {
	...
	// Проверяем все варианты имен в карте
